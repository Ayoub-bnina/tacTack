...
public class Espace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spacelocation = (TextView) findViewById(R.id.spaceLocation);
        ...
        spacelocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                affichelocation();
            }

            private void affichelocation() {
                reff = FirebaseDatabase.getInstance().getReference().child("spaceName").child("1");
